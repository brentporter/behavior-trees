...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        Droid droid1 = new Droid("Droid_1", 5, 2, random.nextInt(6)+3, random.nextInt(2)+1, random.nextInt(4)+2);
        Droid droid2 = new Droid("Droid_2", 6, 3, random.nextInt(6)+2, random.nextInt(2)+1, random.nextInt(4)+2);
        Droid droid3 = new Droid("Droid_3", 4, 5, random.nextInt(6)+1, random.nextInt(2)+1, random.nextInt(4)+2);
